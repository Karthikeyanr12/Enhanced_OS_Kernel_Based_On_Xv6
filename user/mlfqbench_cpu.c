...
{
  printf("=== Benchmark 1: CPU-Bound Workload (MLFQ) ===\n");
  printf("Spawning %d CPU-bound worker processes...\n", NUM_CPU_WORKERS);

  int pids[NUM_CPU_WORKERS];
  struct proc_info final_stats[NUM_CPU_WORKERS];
